...
contract CapyCoin is ERC20, Ownable, ERC20Permit {
    // Precio de CapyCoin en wei (1 DEV = cantidad de CapyCoin)
    ...
    /**
     * @dev Función para comprar CapyCoin con DEV
     * Los usuarios envían DEV y reciben CapyCoin desde las reservas del contrato
     */
    function buyCapyCoin() external payable {
        require(msg.value > 0, "Must send DEV to buy tokens");
    ...
    /**
     * @dev Retirar DEV del contrato (solo owner)
     */
    ...
    /**
     * @dev Función de emergencia para retirar una cantidad específica de DEV
     */
    ...
    /**
     * @dev Ver cuántos tokens se pueden comprar con cierta cantidad de DEV
     */
    ...
    /**
     * @dev Ver cuánto DEV se necesita para comprar cierta cantidad de tokens
     */
    ...
    /**
     * @dev Ver el balance de DEV del contrato
     */
    function contractDEVBalance() external view returns (uint256) {
    ...
    /**
     * @dev Función para recibir DEV directamente (auto-compra tokens)
     */
