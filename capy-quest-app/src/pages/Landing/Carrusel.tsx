...
export default function Carrusel() {
  ...
  const capybarasLeft = [
    { id: 1, color: 'bg-orange-200', image: '/img/capy/capybaby.jpeg' },
    { id: 2, color: 'bg-blue-200', image: '/img/capy/capybaby.jpeg' },
    { id: 3, color: 'bg-orange-300', image: '/img/capy/capyexplorebaby.jpeg' },
    { id: 4, color: 'bg-purple-200', image: '/img/capy/capygrandpa.jpeg' },
    { id: 5, color: 'bg-green-200', image: '/img/capy/capyexplorebaby.jpeg' },
    { id: 6, color: 'bg-pink-200', image: '/img/capy/capygolden.jpeg' }
  ];

  const capybarasRight = [
    { id: 7, color: 'bg-yellow-200', image: '/img/capy/capybaby.jpeg' },
    { id: 8, color: 'bg-red-200', image: '/img/capy/capybaby.jpeg' },
    { id: 9, color: 'bg-teal-200',  image: '/img/capy/capyexplorebaby.jpeg' },
    { id: 10, color: 'bg-indigo-200', image: '/img/capy/capygrandpa.jpeg' },
    { id: 11, color: 'bg-lime-200', image: '/img/capy/capyexplorebaby.jpeg' },
    { id: 12, color: 'bg-rose-200', image: '/img/capy/capygolden.jpeg' }
  ];
